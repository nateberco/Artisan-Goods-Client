...
const Auth = (props) => {
    ...
    return(
        ...
        <Container className = "auth-container align-middle" style={{padding: 10}} >
            
            <div style={{ width: "2000px",  marginLeft: "-80%"}}class="custom-shape-divider-bottom-1614655104">
                <svg  style={{width: "auto"}} data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
            ...
            <div className="pinkLoginDiv"></div>
